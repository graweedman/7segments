...
#define DIGIT4_Pin GPIO_PIN_1
#define DIGIT4_GPIO_Port GPIOD
#define DIGIT3_Pin GPIO_PIN_2
#define DIGIT3_GPIO_Port GPIOD
#define DIGIT2_Pin GPIO_PIN_3
#define DIGIT2_GPIO_Port GPIOD
#define DIGIT1_Pin GPIO_PIN_4
#define DIGIT1_GPIO_Port GPIOD
#define SHIFT_DATA_Pin GPIO_PIN_5
#define SHIFT_DATA_GPIO_Port GPIOD
#define SHIFT_CLKOUT_Pin GPIO_PIN_6
#define SHIFT_CLKOUT_GPIO_Port GPIOD
#define SHIFT_CLKIN_Pin GPIO_PIN_7
#define SHIFT_CLKIN_GPIO_Port GPIOD
